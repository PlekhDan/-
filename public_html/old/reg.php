    ...
    <body>
        ...
        <nav class="navbar navbar-expand-md navbar-light bg-light">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <a class = "btn btn-outline-dark me-3" href="auth.php">
        ...
        <div class = "container py-3">
            <div class = "col-sm-5 mx-auto my-5">
                <h2 class = "my-5 text-center">Регистрация на сайте</h2>
                <form onsubmit = "sendForm(this); return false;" class = "text-center">
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <input required name = "password" type="password" class="form-control" placeholder = "Пароль">
                    </div>
            ...
            fetch("php/hendlerReg.php", {
              ...
              .then((result) => {
                  ...
                  if (result.result == "success") {
                      form.innerHTML = `<i class="fas fa-check fa-2x text-success"> <br\><br\> </i><h6 class = "text-success">Регистрация успешно завершена!</h6>`;
                  } else {
                      info.innerText = "Пользователь с таким email уже существует!";
                  }
                  console.log(result);
              });
        }
